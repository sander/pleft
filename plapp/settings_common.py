...
# This header is prepended to all compiled JS files and gives permission to
# distribute them according to the terms below.
JS_HEADER = """// Copyright 2009, 2010 Sander Dijkhuis <sander.dijkhuis@gmail.com>
//
